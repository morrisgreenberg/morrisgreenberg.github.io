...
// "system", the site defaults to "light" regardless of the visitor's OS/browser
// preference (customized from the theme default, which would otherwise follow
// prefers-color-scheme). Visitors can still switch to dark manually via the toggle.
